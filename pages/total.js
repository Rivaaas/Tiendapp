...
export default function Total() {
  ...
  return (
    <Layout pagina="Total">
      <h1 className="text-4xl font-black mt-5">Confirmar pedido</h1>
      <p className="text-2xl my-10">Confirma pedido a continuación</p>
      ...
      <form onSubmit={colocarOrden}>
        <div>
          ...
          <input
            ...
            value={nombre}
            className="bg-gray-200 w-full mt-3 lg:w-1/3 mt-3 p-2 rounded-md"
          />
        </div>
        <div className="mt-10">
